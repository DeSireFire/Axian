...
__all__ = ['bytes_format', 'bytes_format_detail']
...
def bytes_format_detail(size, dot=2):
    """
    字节转其它单位大小,详细
    :param size: 字节大小
    :param dot: 保留小数
    ...
    # 负数
        ...
        raise ValueError('{}() takes number than or equal to 0, but less than 0 given.'.format(bytes_format_detail.__name__))
    return human_size
